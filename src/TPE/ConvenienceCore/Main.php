...
class Main extends PluginBase implements Listener {
    ...
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args): bool
    {
      ...
      if($this->config->get("advertise-feature-disabled") == false) {
          if($command->getName() == "advertise") {
              if($sender instanceof Player) {
                  if ($sender->hasPermission("advertise.allow")) {
                      $itemb = $sender->getInventory()->getItemInHand();
                      if($itemb->isNull()) {
                          $sender->sendMessage($this->config->get("message-sent-to-player-when-hand-is-empty-advertise"));
                          return false;
                      }
                      $item = $sender->getInventory()->getItemInHand()->getName();
                      $itemc = $sender->getInventory()->getItemInHand()->getCount();
                      $player = $sender->getName();
                      $itemec = $sender->getInventory()->getItemInHand()->getEnchantments();
                      if(!$itemb->hasEnchantments()) {
                          $this->getServer()->broadcastMessage(TextFormat::BOLD . TextFormat::GOLD . TextFormat::ITALIC . "AD " . TextFormat::RESET . TextFormat::AQUA . TextFormat::BOLD . "$player " . TextFormat::RESET . TextFormat::GREEN . "is advertising " . TextFormat::BOLD . TextFormat::GREEN . "X" . TextFormat::RESET . TextFormat::GREEN . "$itemc " . TextFormat::RESET . TextFormat::GREEN . "of " . TextFormat::RESET . TextFormat::BOLD . "$item");
                      }
                      if($itemb->hasEnchantments()) {
                          $this->getServer()->broadcastMessage(TextFormat::BOLD . TextFormat::GOLD . TextFormat::ITALIC . "AD " . TextFormat::RESET . TextFormat::AQUA . TextFormat::BOLD . "$player " . TextFormat::RESET . TextFormat::GREEN . "is advertising " . TextFormat::BOLD . TextFormat::GREEN . "X" . TextFormat::RESET . TextFormat::GREEN . "$itemc " . TextFormat::RESET . TextFormat::GREEN . "of " . TextFormat::RESET . TextFormat::BOLD . "$item" . TextFormat::RESET . TextFormat::GREEN .  "which has the following enchantments:" . "\n");
                      }

                  } else {
                      $sender->sendMessage($this->config->get("no-perms-message-advertise"));
                  }
          ...
          $sender->sendMessage($this->config->get("advertise-feature-disabled-message"));
      }
      return true;
    }
